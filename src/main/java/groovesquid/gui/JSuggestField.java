...
import groovesquid.util.matcher.ContainsMatcher;
import groovesquid.util.matcher.SuggestMatcher;
...
public class JSuggestField extends JTextField {
	 ...
	 */
	public JSuggestField(Frame owner, List<String> data) {
		this(owner);
		setSuggestData(data);
	}
	...
	public List<String> getSuggestData() {
		return (List<String>) ((ArrayList<String>) data).clone();
	}
